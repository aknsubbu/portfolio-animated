	...
	const projectInfo = [
		...
		},
		{
		  ...
		  },
		  {
			...
			title_line: "News Vision",
			imagePath: "./newsVisionRepo.jpeg",
			indexNumber: "03",
			description: "We have created a software that helps to convert news articles into MP4 videos where the articles are read out along with the visuals that are supplied across more than 160 languages. The conversion is run in python and wrapped in a Flask module to be easy to interface with and the front end is built on Next JS. We have a rudimentary backend for CRUD Operations and Auth Procedures. We have displayed our sample input and output in our GitHub Repository which is also linked below....",
			repoLink: "https://github.com/aknsubbu/sns-hackathon-aiConversion"
		  },
